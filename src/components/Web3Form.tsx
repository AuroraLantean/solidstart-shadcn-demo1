...
const Web3Form: Component<Web3FormProps> = (props: Web3FormProps) => {
  ...
  const [addr, setAddr] = createSignal<string>("");
	...
	const writeToBlockchain = () => {
		ll(`writeToBlockchain. switchValue: ${switchValue()}, radioValue: ${radioValue()}, addr:${addr()}, numInput: ${numInput()}`)
		return 
	}
...
<Button class="btn hover:bg-orange-600" type="default" onclick={writeToBlockchain} >Write to Blockchain</Button>
